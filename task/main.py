...
class DiscoverGranules:
    ...
    def get_file_updates(fileList: List[File]):
        for i, file in enumerate(fileList):
            ...
            print(f'Comparing [{file.date_modified}]:[{date_modified_list[index]}]')
            print(f'Comparing [{file.time_modified}]:[{time_modified_list[index]}]')
            print(f'Comparing [{file.meridiem_modified}]:[{meridiem_list[index]}]')
