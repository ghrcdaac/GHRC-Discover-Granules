...
class TestDGM(unittest.TestCase):
    ...
    def test_db_select_all(self):
        discovered_granules = {"granule_a": {"ETag": "tag1_a", "GranuleId": "granule_id1", "Last-Modified": "modified_a"},
                               "granule_b": {"ETag": "tag1_b", "GranuleId": "granule_id1", "Last-Modified": "modified_b"}}
    ...
    def test_db_error_exception(self):
        discovered_granules = {"granule_a": {"ETag": "tag1", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
    ...
    def test_db_error_no_exception(self):
        discovered_granules_1 = {"granule_a": {"ETag": "tag1", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
        discovered_granules_2 = {"granule_b": {"ETag": "tag2", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
    ...
    def test_db_skip_update_etag(self):
        discovered_granules_1 = {"granule_a": {"ETag": "tag1", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
        discovered_granules_2 = {'granule_a': {"ETag": "tag1_a", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
    ...
    def test_db_skip_new_granule(self):
        discovered_granule_a = {"granule_a": {"ETag": "tag1_a", "GranuleId": "granule_id1", "Last-Modified": "modified_a"}}
        discovered_granule_b = {"granule_b": {"ETag": "tag1_b", "GranuleId": "granule_id1", "Last-Modified": "modified_b"}}
    ...
    def test_db_replace(self):
        discovered_granules = {"granule_a": {"ETag": "tag1a", "GranuleId": "granule_id1", "Last-Modified": "modified"}}
    ...
    def test_db_delete_granules_by_name(self):
        discovered_granules = {"granule_a": {"ETag": "tag1_a", "GranuleId": "granule_id1", "Last-Modified": "modified_a"},
                               "granule_b": {"ETag": "tag1_b", "GranuleId": "granule_id2", "Last-Modified": "modified_b"}}
        num1 = self.model.db_skip(discovered_granules)
